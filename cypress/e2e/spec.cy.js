describe('MY STORE', () =>{
    ...
    context('Users are able to search for an item using the search bar', () =>{
        it('allows a user search for items', () =>{
            ...
            cy.url().and('eq','http://automationpractice.com/index.php?controller=search&orderby=position&orderway=desc&search_query=dress&submit_search=') //asserts that the url has change    
